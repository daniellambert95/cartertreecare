        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link 
              ...
              className="px-8 py-4 rounded-md bg-[#25D366] text-white font-medium text-lg shadow-lg hover:bg-[#128C7E] transform hover:-translate-y-1 transition duration-300 text-center flex items-center gap-2"
            >
