...
export const metadata = {
  title: 'Cookie-Richtlinie | Der Baumchirurg',
  description: 'Erfahren Sie, welche Cookies wir verwenden und wie wir Ihre Daten schützen. Transparente Information über unsere Cookie-Nutzung.',
  keywords: 'cookies, datenschutz, cookie-richtlinie, dsgvo, baumpflege',
};
          ...
          <div className="py-8 sm:py-12 md:py-16 lg:py-24">
            ...
            <nav className="flex mb-6 md:mb-8" aria-label="Breadcrumb">
              <ol className="flex items-center space-x-2">
                ...
                <li className="flex items-center">
                  ...
                  <span className="ml-2 text-neutral text-sm font-medium">Cookie-Richtlinie</span>
                </li>
              </ol>
            </nav>
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-neutral/80 mb-6 lg:mb-8 leading-relaxed max-w-3xl mx-auto">
                Erfahren Sie, welche Cookies wir verwenden und wie wir Ihre Daten schützen. 
                Wir sind zu vollständiger Transparenz verpflichtet.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-20 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="prose prose-lg max-w-none">
            ...
            {/* Introduction */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-neutral mb-4">Was sind Cookies?</h2>
              <p className="text-neutral/80 leading-relaxed mb-4">
                ...
                Sie enthalten Informationen über Ihre Nutzung der Website und helfen uns dabei, Ihnen ein besseres 
                Browsing-Erlebnis zu bieten.
              </p>
              <p className="text-neutral/80 leading-relaxed">
                Gemäß der Datenschutz-Grundverordnung (DSGVO) und dem Telekommunikation-Telemedien-Datenschutz-Gesetz (TTDSG) 
                sind wir verpflichtet, Sie über die Verwendung von Cookies zu informieren und Ihre Einwilligung einzuholen.
              </p>
            </div>
