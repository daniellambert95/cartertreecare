      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral mb-4">Expertenwissen & Ratgeber</h2>
            <p className="text-lg text-neutral/70 max-w-2xl mx-auto">
              Erfahren Sie mehr über professionelle Baumpflege in unseren detaillierten Ratgebern und Leitfäden.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Link href="/blog/wie-man-bäume-schneidet" className="group block">
              <div className="bg-secondary rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-neutral/70">
                  Lernen Sie die richtige Technik für professionellen Baumschnitt - mit praktischen Tipps von unseren Experten.
                </p>
              </div>
            </Link>
            ...
            <Link href="/blog/baumkrankheiten-erkennen" className="group block">
              <div className="bg-secondary rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-neutral/70">
                  Früherkennung von Baumkrankheiten kann Ihre Bäume retten. Lernen Sie die wichtigsten Warnsignale kennen.
                </p>
              </div>
            </Link>
            ...
            <Link href="/ueber-uns" className="group block">
              <div className="bg-secondary rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-neutral/70">
                  Lernen Sie unsere zertifizierten Baumpflege-Experten kennen und erfahren Sie mehr über unsere Philosophie.
                </p>
              </div>
            </Link>
          </div>
          ...
          <div className="mt-12 text-center">
            <h3 className="text-xl font-bold text-neutral mb-6">Weitere hilfreiche Informationen</h3>
