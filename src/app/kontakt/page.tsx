...
export default function ContactPage() {
  return (
    <main className="min-h-screen flex flex-col bg-secondary">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 md:gap-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm sm:text-base text-neutral font-medium">Schnelle Antwort</span>
                  </div>
                  <div className="flex items-center">
                    <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-primary/15 flex items-center justify-center text-primary mr-2 sm:mr-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-sm sm:text-base text-neutral font-medium">Flexible Terminplanung</span>
                  </div>
                  <div className="flex items-center">
                    <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-primary/15 flex items-center justify-center text-primary mr-2 sm:mr-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 sm:h-5 sm:w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-sm sm:text-base text-neutral font-medium">Kostenlose Erstberatung</span>
                  </div>
                </div>
              </div>
      ...
      {/* Contact Section */}
      <section className="py-10 md:py-20 bg-secondary relative">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 mb-8">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-base sm:text-lg font-semibold text-neutral mb-1">Telefon / WhatsApp</h3>
