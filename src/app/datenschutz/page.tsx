...
export const metadata = {
  title: 'Datenschutzerklärung | Der Baumchirurg',
  description: 'Datenschutzerklärung der Der Baumchirurg. Erfahren Sie, wie wir Ihre Daten schützen und verarbeiten.',
          ...
          <div className="prose prose-lg max-w-none">
              ...
              <div className="bg-neutral/5 rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="text-neutral/80 space-y-1">
                      <div>📧 derbaumchirurg@gmail.com</div>
            ...
            <div className="bg-primary/5 rounded-xl p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  <span className="text-white">Datenschutz-Anfrage stellen</span>
                </Link>
                <Link 
