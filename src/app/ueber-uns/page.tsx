    ...
    <main className="min-h-screen flex flex-col bg-secondary">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-neutral font-medium">Höchste Qualität</span>
                  </div>
                  <div className="flex items-center">
                    <div className="h-10 w-10 rounded-full bg-primary/15 flex items-center justify-center text-primary mr-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-neutral font-medium">Zuverlässigkeit</span>
                  </div>
                  <div className="flex items-center">
                    <div className="h-10 w-10 rounded-full bg-primary/15 flex items-center justify-center text-primary mr-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-neutral font-medium">Erfahrenes Team</span>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-secondary relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-neutral mb-4">Unsere Unternehmenswerte</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              <div className="h-16 w-16 rounded-full bg-primary/15 flex items-center justify-center text-primary mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-neutral mb-3">Flexibilität und Kundenorientierung</h3>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-neutral mb-3">Fachkompetenz</h3>
              <p className="text-neutral/80">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-neutral mb-3">Kontinuierliche Weiterbildung</h3>
              <p className="text-neutral/80">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-neutral mb-3">Umfangreicher Fuhrpark</h3>
              <p className="text-neutral/80">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-neutral mb-3">Zuverlässigkeit</h3>
              <p className="text-neutral/80">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-neutral mb-3">Netzwerk</h3>
              <p className="text-neutral/80">
      ...
      <section className="py-16 bg-secondary-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-neutral mb-6">Unser soziales Engagement</h2>
              ...
              <div className="flex space-x-4 mt-8">
                <a href="#" className="h-12 w-12 rounded-full bg-primary/15 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors duration-300">
      ...
      <section className="py-16 bg-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-neutral mb-6">Bereit, mit uns zusammenzuarbeiten?</h2>
